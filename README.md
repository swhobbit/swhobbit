...
I've made money (in chronological order of first professional use, **not** level of expertise!) using `COBOL`, `PL/I`, `IBM Assembler`, `ROSCOE RPF`, `EXEC2`, `REXX`, `VMS DCL`, `C/C++`, `Java`, `Bourne Shell` (and  its successors), `Python`, `Perl`, `JS`, and `FORTRAN IV`.
